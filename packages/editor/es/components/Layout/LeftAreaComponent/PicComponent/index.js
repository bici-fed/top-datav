...
var Layout = function Layout(_ref) {
  ...
  var requstPicList = function requstPicList() {
    clientParam(uploaConfig.self.baseURL).request({
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              clientParam(uploaConfig.baseURL).post(uploaConfig.self.apiUrl.update, {
                id: selectedItem.id,
  ...
  var handleDelete = function handleDelete() {
    ...
    clientParam(uploaConfig.baseURL).get(uploaConfig.self.apiUrl.delete, {
      headers: {
        token: uploaConfig.self.token
      },
      params: {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    header: "\u81EA\u5B9A\u4E49\u4E0A\u4F20",
    key: "998"
  }, /*#__PURE__*/React.createElement(Row, null, list === null || list === void 0 ? void 0 : list.map(function (item, index) {
  ...
  }, "\u4E0A\u4F20")))))), ((uploaConfig === null || uploaConfig === void 0 ? void 0 : (_uploaConfig$industry = uploaConfig.industry) === null || _uploaConfig$industry === void 0 ? void 0 : _uploaConfig$industry.projectIndustryCats) || industry_List).map(function (item, index) {
