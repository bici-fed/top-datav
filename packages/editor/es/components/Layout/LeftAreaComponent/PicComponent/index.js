...
var Layout = function Layout(_ref) {
  ...
  (0, _react.useEffect)(function () {
    requstPicList();
  }, [uploaConfig.self]); // 请求获取图片列表

  var requstPicList = function requstPicList() {
    (0, _api.clientParam)(uploaConfig.self.baseURL).request({
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              (0, _api.clientParam)(uploaConfig.baseURL).post(uploaConfig.self.apiUrl.update, {
                id: selectedItem.id,
  ...
  var handleDelete = function handleDelete() {
    ...
    (0, _api.clientParam)(uploaConfig.baseURL).get(uploaConfig.self.apiUrl["delete"], {
      headers: {
        token: uploaConfig.self.token
      },
      params: {
  ...
  return /*#__PURE__*/_react["default"].createElement("div", {
    ...
    header: "\u81EA\u5B9A\u4E49\u4E0A\u4F20",
    key: "998"
  }, /*#__PURE__*/_react["default"].createElement(_antd.Row, null, list === null || list === void 0 ? void 0 : list.map(function (item, index) {
  ...
  }, "\u4E0A\u4F20")))))), ((uploaConfig === null || uploaConfig === void 0 ? void 0 : (_uploaConfig$industry = uploaConfig.industry) === null || _uploaConfig$industry === void 0 ? void 0 : _uploaConfig$industry.projectIndustryCats) || _config.industry_List).map(function (item, index) {
