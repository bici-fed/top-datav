...
var IndustryList = function IndustryList(props) {
  ...
  var requstPicList = function requstPicList() {
    (0, _api.clientParam)(uploaConfig.industry.baseURL).request({
  ...
  return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement(_antd.Row, null, (list || []).map(function (item, index) {
