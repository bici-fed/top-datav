...
var Page = function Page(_ref) {
  ...
  var renderFontForm = function renderFontForm(item, idx) {
    return /*#__PURE__*/_react["default"].createElement(_antd.Form, {
      ...
      value: "0"
    }, "\u5355\u51FB"), /*#__PURE__*/_react["default"].createElement(_antd.Select.Option, {
      value: "1"
    }, "\u53CC\u51FB"), /*#__PURE__*/_react["default"].createElement(_antd.Select.Option, {
      value: "2"
    }, "webSocket\u4E8B\u4EF6"), /*#__PURE__*/_react["default"].createElement(_antd.Select.Option, {
      value: "3"
    }, "MQTT")))), renderFormByEventType(item, idx));
  };
  /**
   * 根据事件类型渲染事件行为表单
   */
  ...
  var renderFormByEventType = function renderFormByEventType(item, idx) {
    var renderCommonForm = function renderCommonForm() {
      return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement(_antd.Col, {
        ...
        value: "0"
      }, "\u8DF3\u8F6C\u94FE\u63A5"), /*#__PURE__*/_react["default"].createElement(_antd.Select.Option, {
        value: "1"
      }, "\u6267\u884C\u52A8\u753B"), /*#__PURE__*/_react["default"].createElement(_antd.Select.Option, {
        value: "2"
      }, "\u6267\u884C\u51FD\u6570"), /*#__PURE__*/_react["default"].createElement(_antd.Select.Option, {
        value: "3"
      }, "\u6267\u884Cwindow\u4E0B\u7684\u5168\u5C40\u51FD\u6570"), /*#__PURE__*/_react["default"].createElement(_antd.Select.Option, {
        value: "4"
      }, "\u66F4\u65B0\u5C5E\u6027\u6570\u636E")))), renderFormByEvent(item, idx));
    };
  ...
  var onHandleCodeChange = function onHandleCodeChange(e, idx) {// validateFields((err, value) => {
    //   if (err) return;
    //   eventData[idx] = {
    //     type: null,
    //     action: null,
  ...
  var onHandleDeleteItem = (0, _react.useCallback)(function (idx) {
    var data = _toConsumableArray(eventData);
  ...
  var renderPanel = (0, _react.useMemo)(function () {
    if (eventData.length < 1) return;
    return /*#__PURE__*/_react["default"].createElement(_antd.Collapse, null, eventData.map(function (item) {
      ...
      return /*#__PURE__*/_react["default"].createElement(Panel, {
        header: /*#__PURE__*/_react["default"].createElement("a", null, "\u81EA\u5B9A\u4E49\u4E8B\u4EF6".concat(index + 1), ' ', /*#__PURE__*/_react["default"].createElement("span", {
