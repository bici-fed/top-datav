...
var MQTTForm = function MQTTForm() {
  ...
  */
  ...
  var onHandleConnectMQTT = function onHandleConnectMQTT() {// validateFields((err, value) => {
    //   if(err) return;
  ...
  return /*#__PURE__*/_react["default"].createElement(_antd.Form, _objectSpread(_objectSpread({}, formLayout), {}, {
    form: form
    ...
    placeholder: "\u8BF7\u8F93\u5165Client ID\uFF08\u4E0D\u80FD\u91CD\u590D\u4F7F\u7528\uFF0C\u53EF\u4E3A\u7A7A)"
  }))), /*#__PURE__*/_react["default"].createElement(_antd.Col, {
    span: 24
  }, /*#__PURE__*/_react["default"].createElement(_antd.Form.Item, {
    label: "\u7528\u6237\u540D"
