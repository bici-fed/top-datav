...
var EditorLayout = /*#__PURE__*/ React.forwardRef(function (props, ref) {
  ...
  var _useState7 = useState({
      ...
      width:
        (props === null || props === void 0
          ? void 0
          : (_props$editorData = props.editorData) === null || _props$editorData === void 0
          ? void 0
          : _props$editorData.width) || 826,
      height:
        (props === null || props === void 0
          ? void 0
          : (_props$editorData2 = props.editorData) === null || _props$editorData2 === void 0
          ? void 0
    ...
    if (showLimit !== undefined) {
      selected.node.children[1].text = showLimit
        ? '\u4E0B\u9650: '
            ...
            .concat(!isNaN(parseInt(value['limit.top'])) ? value['limit.top'] : '')
        : '';
    }
  ...
  var handleCustomizedDynamicFormChange = function handleCustomizedDynamicFormChange(
    group,
    fields,
  ) {
  ...
  var renderContextMenu = /*#__PURE__*/ React.createElement(
    ...
    /*#__PURE__*/ React.createElement(CanvasContextMenu, {
      ...
      getNewComponents:
        (_customCompRef$curren = customCompRef.current) === null || _customCompRef$curren === void 0
          ? void 0
