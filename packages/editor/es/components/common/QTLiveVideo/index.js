...
var QTLiveVideo = /*#__PURE__*/function (_Component) {
  ...
  function QTLiveVideo(props) {
    ...
    _this.state = {
      ...
      pushStream: (_node$property$video4 = node.property.video) === null || _node$property$video4 === void 0 ? void 0 : _node$property$video4.pushStream,
  ...
  _createClass(QTLiveVideo, [{
    ...
    value: function componentDidMount() {
      ...
      this.setState({
        videoObj: (_node$property$video5 = node.property.video) === null || _node$property$video5 === void 0 ? void 0 : _node$property$video5.selectedRows[0]
      });
