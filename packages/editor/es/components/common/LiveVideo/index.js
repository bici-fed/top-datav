...
var LiveVideo = /*#__PURE__*/function (_Component) {
  ...
  function LiveVideo(props) {
    ...
    _this.updateVideoUrl = /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(id, rate) {
        var flag, data;
            ...
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                if (data && data.length && data[0].flv) {
                  _this.setState(_objectSpread(_objectSpread({}, _this.state.videoObj), {}, {
                    flv: data[0].flv,
                    rate: data[0].rate
                  }));
    ...
    var videoObj = (_node$property$video = node.property.video) === null || _node$property$video === void 0 ? void 0 : _node$property$video.selectedRows[0];
    _this.state = {
      videoObj: videoObj,
      rePushStream: (_node$property$video2 = node.property.video) === null || _node$property$video2 === void 0 ? void 0 : _node$property$video2.rePushStream,
      updateStream: (_node$property$video3 = node.property.video) === null || _node$property$video3 === void 0 ? void 0 : _node$property$video3.updateStream
    };
    return _this;
  }
  ...
  _createClass(LiveVideo, [{
    ...
    value: function componentDidMount() {
      ...
      this.setState({
        videoObj: (_node$property$video4 = node.property.video) === null || _node$property$video4 === void 0 ? void 0 : _node$property$video4.selectedRows[0]
      });
      var that = this;
    ...
    value: function render() {
      ...
      var videoObj = (_this$props$node$prop = this.props.node.property.video) === null || _this$props$node$prop === void 0 ? void 0 : _this$props$node$prop.selectedRows[0];
