...
var ResizePanel = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(ResizePanel, [{
    ...
    value: function componentDidMount() {
      ...
      var initialSize = this.isHorizontal() ? $(actualContent).outerWidth(true) : $(actualContent).outerHeight(true); // Initialize the size value based on the content's current size
    ...
    value: function validateSize() {
      ...
      var margins = isHorizontal ? $(actualContent).outerWidth(true) - $(actualContent).outerWidth() : $(actualContent).outerHeight(true) - $(actualContent).outerHeight();
      minSize += margins;
    ...
    value: function render() {
      ...
      var handle = /*#__PURE__*/React.createElement(DraggableCore, _objectSpread(_objectSpread({
        key: "handle"
      }, dragHandlers), {}, {
        allowAnyClick: true
        ...
        onClick: handleClick
      }, /*#__PURE__*/React.createElement("span", null)))); // Insert the handle at the beginning of the content if our directio is west or north
