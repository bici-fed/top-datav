      ...
      if (_Layout.canvas.socket != undefined) {
        (_Layout.canvas.data.pens || []).map(function (node) {
          ...
          if (((_node$property = node.property) === null || _node$property === void 0 ? void 0 : (_node$property$dataPo = _node$property.dataPointParam) === null || _node$property$dataPo === void 0 ? void 0 : (_node$property$dataPo2 = _node$property$dataPo.qtDataList) === null || _node$property$dataPo2 === void 0 ? void 0 : _node$property$dataPo2.length) > 0) {
            _Layout.canvas.socket.socket.send(JSON.stringify(_objectSpread(_objectSpread({}, node.property.dataPointParam), {}, {
              tid: node.TID,
              id: node.id
            })));
            ...
            _Layout.canvas.socket.socket.send(JSON.stringify(_objectSpread(_objectSpread({}, node.data.property.dataPointParam), {}, {
              tid: node.TID,
              id: node.id
            })));
          }
