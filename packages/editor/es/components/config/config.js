...
var defaultToolsConfig = ['rectangle', 'circle', 'text', 'biciTimer', 'biciVarer', 'biciPilot', 'biciText', 'biciCard', 'biciCard2', 'line', 'webPage', 'dataTable', 'liveVideo', 'video', 'groupBar', 'verticalBar', 'stackBar', 'horizontalBar', 'circleAndPie', 'gauge', 'biciMeasure', 'timeLine', 'gbImage', 'productionStatus', 'pointEnergyCarousel', 'dateFormat'];
