        ...
        if (node.property.stateType === 'single') {
          if (node.property.showText !== undefined) {
            ...
            if (item.lightRangeVal == r.value + '') {
              node.strokeStyle = (item === null || item === void 0 ? void 0 : item.lightRangeColor) || node.strokeStyle;
              node.text = (item === null || item === void 0 ? void 0 : item.lightRangeText) || node.property.text;
              node.font.color = (item === null || item === void 0 ? void 0 : item.lightRangeColor) || node.font.color;
              flag = true;
              break;
            }
          }
...
var Preview = function Preview(_ref) {
  ...
  useEffect(function () {
    ...
    var websocketIntv = setInterval(function () {
      ...
      if (canvas != undefined && ((_canvas$socket = canvas.socket) === null || _canvas$socket === void 0 ? void 0 : _canvas$socket.socket.readyState) !== 1) {
        initWebsocketData();
      } else {
    ...
    (pens || []).map(function (node) {
      ...
      if (node.name == 'combine') {
        ...
        if (node.name == 'biciVarer') {
          ...
          if (((_node$property$dataPo4 = node.property.dataPointSelectedRows[0]) === null || _node$property$dataPo4 === void 0 ? void 0 : _node$property$dataPo4.dataCode) == r.id) {
