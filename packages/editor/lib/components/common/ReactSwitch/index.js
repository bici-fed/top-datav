...
var _excluded = ["disabled", "className", "offColor", "onColor", "offHandleColor", "onHandleColor", "checkedIcon", "uncheckedIcon", "boxShadow", "activeBoxShadow", "height", "width", "handleDiameter"];
  ...
  _createClass(ReactSwitch, [{
    ...
    value: function render() {
      ...
      var backgroundStyle = {
        ...
        position: 'relative',
        background: (0, _getBackgroundColor["default"])($pos, this.$checkedPos, this.$uncheckedPos, offColor, onColor),
        borderRadius: 2,
      ...
      var handleStyle = {
        ...
        background: (0, _getBackgroundColor["default"])($pos, this.$checkedPos, this.$uncheckedPos, offHandleColor, onHandleColor),
        display: 'inline-block',
        textAlign: 'center',
        cursor: disabled ? 'default' : 'pointer',
        borderRadius: 0,
      ...
      }, checkedIcon), uncheckedIcon && /*#__PURE__*/_react["default"].createElement("div", {
      ...
      }, this.props.checked ? this.props.uncheckedIcon : this.props.checkedIcon), /*#__PURE__*/_react["default"].createElement("input", _extends({
        type: "checkbox",
        role: "switch",
        disabled: disabled,
        style: inputStyle
...
ReactSwitch.propTypes = {
  ...
  uncheckedIcon: _propTypes["default"].oneOfType([_propTypes["default"].bool, _propTypes["default"].element]),
