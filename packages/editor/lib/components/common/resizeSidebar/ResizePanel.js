...
var ResizePanel = /*#__PURE__*/function (_React$Component) {
  ...
  function ResizePanel(props) {
    ...
    _this.validateSize = (0, _lodash["default"])(_this.validateSize, 100).bind(_assertThisInitialized(_this));
    return _this;
  }
  ...
  _createClass(ResizePanel, [{
    ...
    value: function componentDidMount() {
      ...
      var initialSize = this.isHorizontal() ? (0, _cashDom["default"])(actualContent).outerWidth(true) : (0, _cashDom["default"])(actualContent).outerHeight(true); // Initialize the size value based on the content's current size
    ...
    value: function render() {
      ...
      var handle = /*#__PURE__*/_react["default"].createElement(_reactDraggable.DraggableCore, _objectSpread(_objectSpread({
        key: "handle"
      }, dragHandlers), {}, {
        allowAnyClick: true
        ...
        onClick: handleClick
      }, /*#__PURE__*/_react["default"].createElement("span", null)))); // Insert the handle at the beginning of the content if our directio is west or north
