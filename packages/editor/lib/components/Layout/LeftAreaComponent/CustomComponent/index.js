...
var Layout = /*#__PURE__*/(0, _react.forwardRef)(function (props, ref) {
  ...
  function _getNewComponents() {
    (0, _api.clientParam)(combineCom.apiURL).post(combineCom.list.url, combineCom.list.params, {
      headers: {
  ...
  var handleDelete = function handleDelete() {
    (0, _api.clientParam)(combineCom.apiURL).post(combineCom["delete"].url, selectedCom, {
      headers: {
        'X-Requested-With': 'XMLHttpRequest',
        token: combineCom.token,
        'Content-Type': 'application/json'
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              newCom = _objectSpread(_objectSpread({}, selectedCom), {}, {
                componentName: values.componentName
              });
              (0, _api.clientParam)(combineCom.apiURL).post(combineCom.rename.url, newCom, {
                headers: {
                  'X-Requested-With': 'XMLHttpRequest',
                  token: combineCom.token,
                  'Content-Type': 'application/json'
