...
var CanvasContextMenu = /*#__PURE__*/function (_Component) {
  ...
  function CanvasContextMenu() {
    ...
    _this.onCheck = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
  ...
  _createClass(CanvasContextMenu, [{
    ...
    value: function saveNewComponent(params) {
      return (0, _api.clientParam)(this.props.combineCom.apiURL).post(this.props.combineCom.add.url, params, {
        headers: {
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        className: this.props.data.node || this.props.data.nodes ? '' : _indexModule["default"].disabled,
        onClick: this.onTop.bind(this)
      }, "\u7F6E\u9876")), /*#__PURE__*/_react["default"].createElement("div", null, /*#__PURE__*/_react["default"].createElement("a", {
        className: this.props.data.node || this.props.data.nodes ? '' : _indexModule["default"].disabled,
        onClick: this.onBottom.bind(this)
      }, "\u7F6E\u5E95")), /*#__PURE__*/_react["default"].createElement("div", null, /*#__PURE__*/_react["default"].createElement("a", {
        className: this.props.data.node || this.props.data.nodes ? '' : _indexModule["default"].disabled,
        onClick: function onClick() {
          _this2.onNewComponent();
        }
      }, "\u6DFB\u52A0\u5230\u81EA\u5B9A\u4E49\u7EC4\u4EF6")), /*#__PURE__*/_react["default"].createElement("div", {
        className: _indexModule["default"].line
      }), this.props.data.nodes ? /*#__PURE__*/_react["default"].createElement("div", null, /*#__PURE__*/_react["default"].createElement("a", {
        onClick: function onClick() {
          _this2.onCombine(false);
        }
      }, "\u7EC4\u5408")) : null, this.props.data.node && this.props.data.node.name === 'combine' ? /*#__PURE__*/_react["default"].createElement("div", null, /*#__PURE__*/_react["default"].createElement("a", {
        onClick: this.onUncombine
      }, "\u53D6\u6D88\u7EC4\u5408/\u5305\u542B")) : null, this.renderNewComponentModal());
    }
  }]);
