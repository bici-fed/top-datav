...
var Preview = function Preview(_ref) {
  ...
  (0, _react.useEffect)(function () {
    ...
    if (data) {
      canvas.data.pens.filter(function (pen) {
  ...
  var stopCompData = function stopCompData(pens, intval) {
    (pens || []).map(function (node) {
      ...
      } else if (((_node$property = node.property) === null || _node$property === void 0 ? void 0 : (_node$property$dataPo = _node$property.dataPointParam) === null || _node$property$dataPo === void 0 ? void 0 : (_node$property$dataPo2 = _node$property$dataPo.qtDataList) === null || _node$property$dataPo2 === void 0 ? void 0 : _node$property$dataPo2.length) > 0) {
  ...
  var initRestfullData = function initRestfullData(pens) {
    if (pens.length > 0) {
      // 有数据，去遍历所有数据为接口类型的组件
      pens.forEach( /*#__PURE__*/function () {
                  ...
                  if (node.name == 'combine') {
                    ...
                    if (node.property.dataMethod == "restful") {
                      ...
                      if (node.property.pullRate) {
                        interval = setInterval( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
  ...
  var mapRestDataToChart = function mapRestDataToChart(node, res) {
    ...
    if (resTmp) {
      if (resTmp.hasOwnProperty("text") || resTmp.hasOwnProperty("value") || resTmp.hasOwnProperty("unit")) {
        // 说明是统计组件的数据
        var nodeType = node.name;
  ...
  var sendMessage = function sendMessage(pens) {
    (pens || []).map(function (node) {
      ...
      } else if (((_node$property2 = node.property) === null || _node$property2 === void 0 ? void 0 : (_node$property2$dataP = _node$property2.dataPointParam) === null || _node$property2$dataP === void 0 ? void 0 : (_node$property2$dataP2 = _node$property2$dataP.qtDataList) === null || _node$property2$dataP2 === void 0 ? void 0 : _node$property2$dataP2.length) > 0) {
  ...
  var updateComp = function updateComp(pens, data) {
    ...
    (pens || []).map(function (node) {
      ...
      if (node.name == 'combine') {
        ...
        switch (theChart) {
          case 'gauge':
            if (((_node$property$dataPo3 = node.property.dataPointSelectedRows[0]) === null || _node$property$dataPo3 === void 0 ? void 0 : _node$property$dataPo3.dataCode) == r.id) {
              var cd = {
                value: undefined,
          ...
          case 'timeLine':
            ...
            (selectedRows || []).map(function (row, index) {
              if (row.dataCode == r.id) {
                if (index == 0) {
                  timesxAix.push((0, _moment["default"])(parseInt(r.time / 1000 + "") * 1000).format("LTS"));

                  if (timesxAix.length > _defines.defaultTimelineShowData) {
                    timesxAix.splice(1, 1);
                  }

                  node.data.echarts.option = (0, _timeline.getTimeLineOption)(node, null, r, timesxAix, true);
                } else {
      ...
      } else if (((_node$property3 = node.property) === null || _node$property3 === void 0 ? void 0 : (_node$property3$dataP = _node$property3.dataPointParam) === null || _node$property3$dataP === void 0 ? void 0 : (_node$property3$dataP2 = _node$property3$dataP.qtDataList) === null || _node$property3$dataP2 === void 0 ? void 0 : _node$property3$dataP2.length) > 0) {
        // 非图表组件
        if (node.name == 'biciVarer') {
          ...
          console.log('计量器.....', (_node$property$dataPo4 = node.property.dataPointSelectedRows[0]) === null || _node$property$dataPo4 === void 0 ? void 0 : _node$property$dataPo4.dataCode, r.id);

          if (((_node$property$dataPo5 = node.property.dataPointSelectedRows[0]) === null || _node$property$dataPo5 === void 0 ? void 0 : _node$property$dataPo5.dataCode) == r.id) {
          ...
          if (node.property.dataPointParam.qtDataList[0].dataCode == r.id) {
            ...
            if (!isNaN(bottom) && tempVal < bottom && node.property.showLimit) {
              var showColor = node.property.bottomLimit.showBkColor ? node.property.bottomLimit.bkColor : node.property.normal.bkColor; // 小于下限
              ...
              var _showColor = node.property.bottomLimit.showBkColor ? node.property.topLimit.bkColor : node.property.normal.bkColor; // 高于上限


              setCardStyle(node, node.property.topLimit.fontFamily, node.property.topLimit.color, parseInt(node.property.topLimit.fontSize), _showColor);
            } else {
                ...
                for (_iterator.s(); !(_step = _iterator.n()).done;) {
                  ...
                  if (node.property.stateType === 'single') {
                    if (item.lightRangeVal == r.value) {
                      node.strokeStyle = (item === null || item === void 0 ? void 0 : item.lightRangeColor) || node.strokeStyle;
                    ...
                    if (item.lightRangeBottom <= r.value && item.lightRangeTop > r.value || !item.lightRangeBottom && item.lightRangeTop > r.value || !item.lightRangeTop && item.lightRangeBottom <= r.value) {
                      node.strokeStyle = (item === null || item === void 0 ? void 0 : item.lightRangeColor) || node.strokeStyle;
  ...
  var updateChartNode = function updateChartNode(node) {
    ...
    if (_chartDiagram.echartsObjs[node.id]) {
      ...
      _chartDiagram.echartsObjs[node.id].chart.setOption(JSON.parse(JSON.stringify(node.data.echarts.option, _serializing.replacer), _serializing.reviver), true);
