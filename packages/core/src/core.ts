...
export class Topology {
    ...
    if (isMobile()) {
      ...
      this.divLayer.canvas.onmouseup = (event: MouseEvent) => {
        ...
        this.touchedNode.rect.x =
          event.pageX - window.scrollX - this.canvasPos.x - this.touchedNode.rect.width / 2;
        this.touchedNode.rect.y =
          event.pageY - window.scrollY - this.canvasPos.y - this.touchedNode.rect.height / 2;
  ...
  onmouseup = () => {
    ...
    if (this.hoverLayer.dragRect) {
      ...
      if (this.activeLayer.pens && this.activeLayer.pens.length > 1) {
        ...
        this.activeLayer.pens[0].type === PenType.Line
      ) {
        ...
        case MoveInType.HoverAnchors:
          ...
          if (this.hoverLayer.line) {
            ...
            if (this.hoverLayer.line.to.id) {
              ...
              willAddLine =
                !this.options.disableEmptyLine && !this.hoverLayer.line.disableEmptyLine;
            }
  ...
  private switchNodeEditable = (editable: boolean) => {
    const nodeDiv = document.getElementById(this.moveIn.hoverNode.elementId);
