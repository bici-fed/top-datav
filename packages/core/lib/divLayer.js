...
var DivLayer = /*#__PURE__*/function (_Layer) {
  ...
  function DivLayer(parentElem) {
    ...
    _this.subcribeNode = _storeUtils.Store.subscribe(_this.generateStoreKey('LT:activeNode'), function (node) {
  ...
  _createClass(DivLayer, [{
    ...
    value: function createPlayer() {
      ...
      this.progress.onclick = function (e) {
        _this2.media.currentTime = e.offsetX / _this2.progress.clientWidth * _this2.media.duration;
      };
    ...
    value: function setElemPosition(node, elem) {
      ...
      if (this.data.locked > _status.Lock.None || node.locked > _status.Lock.None || node.isEditable) {
