  ...
  function Topology(parent, options) {
    ...
    this.onMouseMove = function (e) {
      ...
      _this.raf = requestAnimationFrame(function () {
        ...
        if (!_this.mouseDown) {
          ...
          if (
            _this.moveIn.hoverNode !== _this.lastHoverNode ||
        ...
        if (!_this.options.disableMoveOutParent && (moveOutX || moveOutY)) {
          ...
          if (_this.options.autoExpandDistance > 0) {
            ...
            _this.scroll(
              moveOutX ? _this.options.autoExpandDistance / 2 : 0,
              moveOutY ? _this.options.autoExpandDistance / 2 : 0,
            );
          }
        }
        ...
        switch (_this.moveIn.type) {
          case MoveInType.None:
            _this.hoverLayer.dragRect = new _rect2.Rect(
              _this.mouseDown.x,
              _this.mouseDown.y,
              e.x - _this.mouseDown.x,
              e.y - _this.mouseDown.y,
            );
            break;
          ...
          case MoveInType.AutoAnchor:
            ...
            _this.hoverLayer.lineTo(
              _this.getLineDock(new _point.Point(e.x, e.y), _status.AnchorMode.In),
              arrow,
            );
          ...
          case MoveInType.LineFrom:
            _this.hoverLayer.lineFrom(
              _this.getLineDock(new _point.Point(e.x, e.y), _status.AnchorMode.Out),
            );
          ...
          case MoveInType.LineControlPoint:
            ...
            if (
              _middles.drawLineFns[_this.moveIn.hoverLine.name] &&
              _middles.drawLineFns[_this.moveIn.hoverLine.name].dockControlPointFn
            ) {
              _middles.drawLineFns[_this.moveIn.hoverLine.name].dockControlPointFn(
                _this.moveIn.hoverLine.controlPoints[_this.moveIn.lineControlPoint.id],
            ...
            _storeUtils.Store.set(_this.generateStoreKey('LT:updateLines'), [
              _this.moveIn.hoverLine,
            ]);
      ...
      switch (_this.moveIn.type) {
        ...
        case MoveInType.HoverAnchors:
          _this.hoverLayer.line = _this.addLine({
            ...
            from: new _point.Point(
              _this.moveIn.hoverNode.rotatedAnchors[_this.moveIn.hoverAnchorIndex].x,
              _this.moveIn.hoverNode.rotatedAnchors[_this.moveIn.hoverAnchorIndex].y,
              _this.moveIn.hoverNode.rotatedAnchors[_this.moveIn.hoverAnchorIndex].direction,
              _this.moveIn.hoverAnchorIndex,
              _this.moveIn.hoverNode.id,
            ),
        ...
        case MoveInType.AutoAnchor:
          _this.hoverLayer.line = _this.addLine({
            name: _this.data.lineName,
            from: new _point.Point(
              _this.moveIn.hoverNode.rect.center.x,
              _this.moveIn.hoverNode.rect.center.y,
    ...
    this.onmouseup = function () {
      ...
      if (_this.hoverLayer.dragRect) {
        ...
        if (_this.activeLayer.pens && _this.activeLayer.pens.length > 1) {
          ...
          _this.activeLayer.pens[0] &&
          _this.activeLayer.pens[0].type === _pen.PenType.Line
        ) {
          _this.dispatch('line', _this.activeLayer.pens[0]);
        } else if (
          _this.activeLayer.pens &&
          _this.activeLayer.pens[0] &&
          _this.activeLayer.pens[0].type === _pen.PenType.Node
        ) {
        ...
        switch (_this.moveIn.type) {
          ...
          case MoveInType.HoverAnchors:
            ...
            if (_this.hoverLayer.line) {
              ...
              if (_this.hoverLayer.line.to.id) {
                ...
                willAddLine =
                  !_this.options.disableEmptyLine && !_this.hoverLayer.line.disableEmptyLine;
              }
          ...
          case MoveInType.AutoAnchor:
            if (
              (_this.hoverLayer.line.disableEmptyLine || _this.options.disableEmptyLine) &&
    ...
    this.ondblclick = function (e) {
      if (_this.moveIn.hoverNode) {
        ...
        var isHoverLineText = _this.moveIn.hoverNode
          .getTextRect()
          .hit(new _point.Point(e.offsetX, e.offsetY));
        ...
        //     );
        var _isHoverLineText = _this.moveIn.hoverLine
          .getTextRect()
          .hit(new _point.Point(e.offsetX, e.offsetY));
    ...
    _storeUtils.Store.set(
      this.generateStoreKey('LT:fontColor'),
      this.options.font.color || '#222222',
    );
  ...
  (0, _createClass2.default)(Topology, [
    ...
    },
    {
      ...
      value: function setupSubscribe() {
        ...
        this.subcribe = _storeUtils.Store.subscribe(
          this.generateStoreKey('LT:render'),
          function () {
            _this2.render();
          },
        );
        ...
        this.subcribeImage = _storeUtils.Store.subscribe(
        ...
        this.subcribeAnimateMoved = _storeUtils.Store.subscribe(
          this.generateStoreKey('LT:rectChanged'),
          function (e) {
            _this2.activeLayer.updateLines(_this2.data.pens);
          },
        );
        this.subcribeMediaEnd = _storeUtils.Store.subscribe(
        ...
        this.subcribeAnimateEnd = _storeUtils.Store.subscribe(
      ...
      value: function setupMouseEvent() {
        ...
        if ((0, _utils.isMobile)()) {
          ...
          this.divLayer.canvas.ontouchstart = function (event) {
            ...
            var pos = new _point.Point(
              event.changedTouches[0].pageX -
                window.scrollX -
                (_this3.canvasPos.left || _this3.canvasPos.x),
              event.changedTouches[0].pageY -
                window.scrollY -
                (_this3.canvasPos.top || _this3.canvasPos.y),
            );
              ...
              if (len === 2) {
                var scale =
                  ...
                  Math.hypot(
                    ...
                    Math.hypot(
                      _this3.touches[0].pageX - _this3.touches[1].pageX,
                      _this3.touches[0].pageY - _this3.touches[1].pageY,
                    );
          ...
          this.divLayer.canvas.onmousedown = function (event) {
            ...
            if (ctrlKey) {
              e = {
                x:
                  event.pageX -
                  _this3.parentElem.scrollLeft -
                  (_this3.canvasPos.left || _this3.canvasPos.x),
                y:
                  event.pageY -
                  _this3.parentElem.scrollTop -
                  (_this3.canvasPos.top || _this3.canvasPos.y),
                ctrlKey: ctrlKey,
                shiftKey: event.shiftKey,
                altKey: event.altKey,
          ...
          this.divLayer.canvas.onmouseup = function (event) {
            ...
            _this3.touchedNode.rect.x =
              event.pageX - window.scrollX - _this3.canvasPos.x - _this3.touchedNode.rect.width / 2;
            _this3.touchedNode.rect.y =
              event.pageY -
              window.scrollY -
              _this3.canvasPos.y -
              _this3.touchedNode.rect.height / 2;
        ...
        this.divLayer.canvas.onwheel = function (event) {
          ...
          event.stopPropagation();
          var pos = new _point.Point(
            event.x - window.scrollX - (_this3.canvasPos.left || _this3.canvasPos.x),
            event.y - window.scrollY - (_this3.canvasPos.top || _this3.canvasPos.y),
          );
    ...
    },
    {
      ...
      value: function ontouchend(event) {
        ...
        this.touchedNode.rect.x =
          ...
          window.scrollX -
          this.canvasPos.x -
          this.touchedNode.rect.width / 2;
        this.touchedNode.rect.y =
          event.changedTouches[0].pageY -
          window.scrollY -
          this.canvasPos.y -
          this.touchedNode.rect.height / 2;
    ...
    },
    {
      ...
      value: function getMoveIn(pt) {
        ...
        if (
          ...
          (0, _canvas.pointInRect)(pt, this.activeLayer.sizeCPs)
        ) {
        ...
        for (var _i2 = len - 1; _i2 > -1; --_i2) {
          if (
            this.data.pens[_i2].type === _pen.PenType.Node &&
            this.inNode(pt, this.data.pens[_i2])
          ) {
            ...
            this.data.pens[_i2].type === _pen.PenType.Line &&
            this.inLine(pt, this.data.pens[_i2])
          ) {
            // 优先判断是否在节点锚点上
    ...
    },
    {
      ...
      value: function inNode(pt, node) {
        ...
        if (
          ...
          !node.visible ||
          node.locked === _status.Lock.NoEvent
        ) {
          return null;
        }
    ...
    },
    {
      ...
      value: function inLine(point, line) {
        if (
          this.data.locked === _status.Lock.NoEvent ||
          !line.visible ||
          line.locked === _status.Lock.NoEvent
        ) {
          return null;
        }
    ...
    },
    {
      ...
      value: function showInput(item, force) {
        if (
          !force &&
          (this.data.locked || item.locked || item.hideInput || this.options.hideInput)
        ) {
          return;
        }
    ...
    },
    {
      ...
      value: function scale(_scale, center) {
        if (
          this.data.scale * _scale < this.options.minScale ||
          this.data.scale * _scale > this.options.maxScale
        ) {
          return;
        }
