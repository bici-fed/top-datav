  ...
  _createClass(RenderLayer, [{
    ...
    value: function loadBkImg(cb) {
      ...
      this.bkImg.onload = function () {
        _this2.bkImgRect = _this2.coverRect(_this2.canvas.width, _this2.canvas.height, _this2.bkImg.width, _this2.bkImg.height);
    ...
    value: function rule() {
      ...
      ctx.save();
      ctx.lineWidth = 1;
      ctx.strokeStyle = (0, _math.rgba)(0.7, this.data.ruleColor || this.options.ruleColor || '#888');
      ctx.beginPath();
