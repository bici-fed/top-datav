...
var Cube = /*#__PURE__*/function () {
  function Cube(rect, z, zRotate) {
    ...
    this.surfaces.push(new Surface(p1, new _point.Point(rect.x + offset, rect.y), new _point.Point(rect.ex, rect.y), p2, (0, _math.pSBC)(0.5, fillStyle), strokeStyle)); // right

    this.surfaces.push(new Surface(p2, new _point.Point(rect.ex, rect.y), new _point.Point(rect.ex, rect.ey - offset), p3, (0, _math.pSBC)(0.6, fillStyle), strokeStyle));
  }
