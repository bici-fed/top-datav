...
var Pen = /*#__PURE__*/function () {
  ...
  _createClass(Pen, [{
    ...
    value: function render(ctx) {
      ...
      ctx.strokeStyle = this.strokeStyle || _storeUtils.Store.get(this.generateStoreKey('LT:color'));
    ...
    value: function doSocketMqtt(item, msg, client) {
      if (item.action < _event.EventAction.Function || item.action === _event.EventAction.StopAnimate) {
