...
var Line = /*#__PURE__*/function (_Pen) {
  ...
  function Line(json) {
    ...
    if (json) {
      if (json.from) {
        _this.from = new _point.Point(json.from.x, json.from.y, json.from.direction, json.from.anchorIndex, json.from.id, json.autoAnchor);
      }

      if (json.to) {
        _this.to = new _point.Point(json.to.x, json.to.y, json.to.direction, json.to.anchorIndex, json.to.id, json.autoAnchor);
      }
    ...
    if (json.controlPoints) {
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          _this.controlPoints.push(new _point.Point(item.x, item.y, item.direction, item.anchorIndex, item.id));
        }
      } catch (err) {
        _iterator.e(err);
      } finally {
  ...
  _createClass(Line, [{
    ...
    value: function draw(ctx) {
      ...
      if (this.fromArrow && _middles.drawArrowFns[this.fromArrow]) {
        ...
        if (this.name === 'curve') {
          f = (0, _curve.getBezierPoint)(0.95 - this.lineWidth / 100, this.to, this.controlPoints[1], this.controlPoints[0], this.from);
      ...
      if (this.toArrow && _middles.drawArrowFns[this.toArrow]) {
        ...
        if (this.name === 'curve') {
          _f = (0, _curve.getBezierPoint)(0.95 - this.lineWidth / 100, this.from, this.controlPoints[0], this.controlPoints[1], this.to);
        } else if (this.name === 'mind') {
          _f = (0, _curve.getBezierPoint)(0.96 - this.lineWidth / 100, this.from, this.controlPoints[0], this.controlPoints[1], this.controlPoints[2]);
        } else if (this.name !== 'line' && this.controlPoints.length) {
    ...
    value: function getLen() {
      switch (this.name) {
        ...
        case 'curve':
          return (0, _canvas.curveLen)(this.from, this.controlPoints[0], this.controlPoints[1], this.to);
      }
    ...
    value: function calcTextRect() {
      ...
      var height = this.font.lineHeight * this.font.fontSize * (this.textMaxLine || this.text && this.text.split('\n').length || 1);
    ...
    value: function getCenter() {
      ...
      switch (this.name) {
        ...
        case 'curve':
          center = (0, _curve.getBezierPoint)(0.5, this.to, this.controlPoints[1], this.controlPoints[0], this.from);
      }
    ...
    value: function getPointByPos(pos) {
      ...
      switch (this.name) {
        ...
        case 'curve':
          return (0, _curve.getBezierPoint)(pos / this.getLen(), this.from, this.controlPoints[0], this.controlPoints[1], this.to);
      }
    ...
    value: function calcRectByParent(parent) {
      ...
      var parentW = parent.rect.width - parent.paddingLeftNum - parent.paddingRightNum;
      var parentH = parent.rect.height - parent.paddingTopNum - parent.paddingBottomNum;
      var x = parent.rect.x + parent.paddingLeftNum + (0, _math.abs)(parentW, this.rectInParent.x) + (0, _math.abs)(parentW, this.rectInParent.marginLeft);
      var y = parent.rect.y + parent.paddingTopNum + (0, _math.abs)(parentH, this.rectInParent.y) + (0, _math.abs)(parentW, this.rectInParent.marginTop);
