...
import { rectangleIconRect, rectangleTextRect } from './nodes/rectangle.rect'; // Functions of drawing a node.

export var drawNodeFns = {}; // Calc the occupy rect of icon.

export var iconRectFns = {}; // Calc the occupy rect of text.

export var textRectFns = {}; // Calc the anchors of node.

export var anchorsFns = {}; // Functions of drawing a line.

export var drawLineFns = {}; // Functions of drawing a arrow.
...
function init() {
  ...
  drawArrowFns.lineDown = lineDown; // ********end********
}
...
export function registerNode(name, drawFn, anchorsFn, iconRectFn, textRectFn) {
...
export function registerArrow(name, drawFn) {
