...
export var HoverLayer = /*#__PURE__*/ (function (_Layer) {
  ...
  function HoverLayer() {
    ...
    Store.set(_this.generateStoreKey('LT:HoverLayer'), _assertThisInitialized(_this));
    return _this;
  }
  ...
  _createClass(HoverLayer, [
    ...
    },
    {
      ...
      value: function render(ctx) {
        ...
        if (this.dockLineY > 0) {
          var _size = Store.get(this.generateStoreKey('LT:size'));
