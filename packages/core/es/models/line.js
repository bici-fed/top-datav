  ...
  _createClass(Line, [{
    ...
    value: function draw(ctx) {
      ...
      if (this.toArrow && drawArrowFns[this.toArrow]) {
        ...
        if (this.name === 'curve') {
          _f = getBezierPoint(0.95 - this.lineWidth / 100, this.from, this.controlPoints[0], this.controlPoints[1], this.to);
        } else if (this.name === 'mind') {
          _f = getBezierPoint(0.96 - this.lineWidth / 100, this.from, this.controlPoints[0], this.controlPoints[1], this.controlPoints[2]);
        } else if (this.name !== 'line' && this.controlPoints.length) {
