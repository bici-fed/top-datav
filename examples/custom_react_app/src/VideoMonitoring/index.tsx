...
import VideoMonitoring from './list';
...
export default class VideoMonitoringModal extends React.PureComponent<any, any> {
  static propTypes = {
  ...
  componentDidUpdate(prevProps, prevState, snapshot) {
    if (this.props.visible !== prevProps.visible) {
      if (
        JSON.stringify(this.props.selectedRowKeys) !== JSON.stringify(this.state.selectedRowKeys)
      ) {
        this.setState({
          selectedRowKeys: this.props.selectedRowKeys,
          selectedRows: this.props.selectedRows,
  ...
  render() {
    ...
    return (
      ...
      >
        <VideoMonitoring isOnlyNumber={false} {...childrenProps} node={this.props.node} />
      </Modal>
    );
  }
}
